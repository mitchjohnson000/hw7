...
public class Printer {
	...
	public static class Formatter implements AST.Visitor<String> {
		...
		@Override
		public String visit(RefExp e, Env env) {
			String result = "(ref ";
		...
		@Override
		public String visit(DeRefExp e, Env env) {
			String result = "(deref ";
			result+=e.exp.accept(this, env);
			return result;
		}
		...
		@Override
		public String visit(AssignExp e, Env env) {
			String result = "(set! ";
			result+=e.exp.accept(this, env) + " ";
			result += e.exp2.accept(this, env);
			return result;
		}

		@Override
		public String visit(FreeExp e, Env env) {
			String result = "(free ";
			result+=e.exp.accept(this, env);
			return result;
		}
