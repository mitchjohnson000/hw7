...
public interface AST {
	...
	public static class AssignExp extends Exp{
		...
		public AssignExp(Exp exp,Exp exp2){
			this.exp = exp;
			this.exp2 = exp2;
		}
	...
	public interface Visitor <T> {
		...
		public T visit(AST.RefExp e, Env env); // Additional expressions for convenience
		public T visit(AST.DeRefExp e, Env env); // Additional expressions for convenience
		public T visit(AST.AssignExp e, Env env); // Additional expressions for convenience
		public T visit(AST.FreeExp e, Env env); // Additional expressions for convenience
